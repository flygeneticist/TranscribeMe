// login_functions.js 
/* 
    A collection of functions that will be used for logging users in and out of site,
    hashing of passwords, database APIs/URLs/Keys, and others... 
*/ 
...
var bcrypt = require('bcryptjs'),
    ...
    db = config.db; // pull the mongodb location 
